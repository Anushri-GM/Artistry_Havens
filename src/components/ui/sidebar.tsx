...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("group peer hidden h-full md:block text-sidebar-foreground", className)}
        data-state={state}
      ...
      >
        <div
          data-sidebar="sidebar"
          className={cn(
            "flex h-full flex-col bg-sidebar transition-all duration-200 ease-linear",
             "w-[var(--sidebar-width)]",
